class Protocol
	...
	io_hash = {type: "yeast"}.merge(io_hash)
        ...
        show {
            ...
            note "Weigh out #{5.36 * multiplier}g nitrogen base, #{1.12 * multiplier}g of DO media, #{16 * multiplier}g of dextrose, #{.064 * multiplier}g adenine sulfate and add to each bottle"
        }
