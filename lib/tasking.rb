module Tasking
  ...
  def task_choose_limit task_ids, task_prototype_name, total_cost=0
    ...
    limit_input = show {
      ...
      note "The total cost for all #{sizes[-1]} #{task_prototype_name}s is $#{total_cost}." if total_cost != 0
    }
